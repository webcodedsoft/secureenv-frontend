    ...
    <div>
      <div className="bg-neutral rounded-t-lg py-4 pl-5 dark:bg-dark-neutral-border">
        <p className="text-gray-1100 leading-4 font-semibold dark:text-gray-dark-1100 text-sm">
          Reset Decryption Password <span className='text-[10px] text-yellow'>Strong Passwords Only—We Don’t Mess with Weak Ones!</span>
        </p>
      </div>
      {showForm ? (
        <form onSubmit={formik.handleSubmit}>
          <div className="flex flex-col p-5 space-y-3">
            <TextField
              ...
              error={formik.touched.recoveryKey ? formik.errors.recoveryKey : ''}
              className="w-32"
            />
            <TextField
