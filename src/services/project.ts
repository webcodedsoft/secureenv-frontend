...
class ProjectService {
  ...
  getProjectContributors = async (
    ...
    try {
      const response = await this.baseService.get(
        `/project/contributors/${projectId}/${projectSlug}/${pageNum}/${pageSize}`
      )
      return response.data
    } catch (error) {
      const err = error as AxiosError<Error>
  ...
  handleContributor = async (
    projectId: number,
    accountId: number
  ): Promise<any> => {
    try {
      const response = await this.baseService.patch(
        `/project/invite-contributor/${projectId}/${accountId}`
      )
      return response.data
    } catch (error) {
      const err = error as AxiosError<Error>
  ...
  toggleProjectLock = async (
    projectId: number,
    isLocked: boolean
  ): Promise<any> => {
    try {
      const response = await this.baseService.patch(
        `/project/${projectId}/${isLocked}`
      )
      return response.data
    } catch (error) {
      const err = error as AxiosError<Error>
  ...
  deleteProject = async (projectId: number) => {
    try {
      const response = await this.baseService.delete(`/project/${projectId}`)
      return response?.data
    } catch (error: any) {
      const err = error as AxiosError<Error>
      return errorHandler(err)
