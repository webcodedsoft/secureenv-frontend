  ...
  return (
    <div className="dropdown dropdown-end">
      <label
        ...
        tabIndex={0}
      >
        <div className="flex items-center p-4 bg-neutral-bg border border-neutral rounded-lg w-[90px] dark:bg-dark-neutral-bg dark:border-dark-neutral-border gap-[5px]">
      ...
      <ul className="dropdown-content" tabIndex={0}>
        <div className="relative menu rounded-box dropdown-shadow w-36 bg-neutral-bg pt-4 pb-2 px-4 border border-neutral-border dark:text-gray-dark-500 dark:border-dark-neutral-border dark:bg-dark-neutral-bg">
          ...
          {options.map((option) => (
            <li className="text-normal mb-2" onClick={() => onSelect(option.value)}>
