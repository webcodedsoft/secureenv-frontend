...
export function Icon({ name, width, height, fill, stroke, className }: IconProps) {
  ...
  if (name === Icons.TypeScript) {
    return (
      <svg fill="none" viewBox="0 0 15 15" height={height ?? "1em"} width={width ?? "1em"} >
        <path
  ...
  if (name === Icons.CSharp) {
    return (
      <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
        fill={fill ?? "currentColor"}
        height={height ?? "1em"}
        width={width ?? "1em"} viewBox="0 0 50 50">
  ...
  if (name === Icons.Filter) {
    return (
      <svg width={width ?? "16"} height={height ?? "16"} viewBox="0 0 16 16" fill={fill ?? "none"} xmlns="http://www.w3.org/2000/svg">
        <path d="M1 1L5.375 7.58824V12.5294L10.625 15V7.58824L15 1H1Z" stroke={stroke ?? "#7E7E8F"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    )
  }
  if (name === Icons.LongBackArrow) {
    return (
      <svg width={width ?? "24"} height={height ?? "24"} viewBox="0 0 24 24" fill={fill ?? "none"} xmlns="http://www.w3.org/2000/svg">
        <path d="M9.57 5.92999L3.5 12L9.57 18.07" stroke={fill ?? "#264653"} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M20.4999 12H3.66992" stroke={fill ?? "#264653"} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    )
  }
  if (name === Icons.Info) {
  ...
  if (name === Icons.Integration) {
    return (
      <svg width={width ?? "20"} height={height ?? "20"} viewBox="0 0 20 20" fill={fill ?? "none"} xmlns="http://www.w3.org/2000/svg">
        <path d="M18.3333 7.1V3.31667C18.3333 2.14167 17.8 1.66667 16.475 1.66667H13.1083C11.7833 1.66667 11.25 2.14167 11.25 3.31667V7.09167C11.25 8.275 11.7833 8.74167 13.1083 8.74167H16.475C17.8 8.75 18.3333 8.275 18.3333 7.1Z" stroke={stroke ?? "#9A9AAF"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M18.3333 16.475V13.1083C18.3333 11.7833 17.8 11.25 16.475 11.25H13.1083C11.7833 11.25 11.25 11.7833 11.25 13.1083V16.475C11.25 17.8 11.7833 18.3333 13.1083 18.3333H16.475C17.8 18.3333 18.3333 17.8 18.3333 16.475Z" stroke={stroke ?? "#9A9AAF"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M8.75008 7.1V3.31667C8.75008 2.14167 8.21675 1.66667 6.89175 1.66667H3.52508C2.20008 1.66667 1.66675 2.14167 1.66675 3.31667V7.09167C1.66675 8.275 2.20008 8.74167 3.52508 8.74167H6.89175C8.21675 8.75 8.75008 8.275 8.75008 7.1Z" stroke={stroke ?? "#9A9AAF"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M8.75008 16.475V13.1083C8.75008 11.7833 8.21675 11.25 6.89175 11.25H3.52508C2.20008 11.25 1.66675 11.7833 1.66675 13.1083V16.475C1.66675 17.8 2.20008 18.3333 3.52508 18.3333H6.89175C8.21675 18.3333 8.75008 17.8 8.75008 16.475Z" stroke={stroke ?? "#9A9AAF"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    )
  }
  if (name === Icons.Logout) {
    return (
      <svg width={width ?? "16"} height={height ?? "17"} viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M5.93332 5.54C6.13999 3.14 7.37332 2.16 10.0733 2.16H10.16C13.14 2.16 14.3333 3.35334 14.3333 6.33334V10.68C14.3333 13.66 13.14 14.8533 10.16 14.8533H10.0733C7.39332 14.8533 6.15999 13.8867 5.93999 11.5267" stroke={stroke ?? "#7E7E8F"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M10 8.5H2.41333" stroke={stroke ?? "#7E7E8F"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M3.89999 6.26666L1.66666 8.5L3.89999 10.7333" stroke={stroke ?? "#7E7E8F"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    )
  }
  ...
  if (name === Icons.Project) {
    return (
      <svg width={width ?? "22"} height={height ?? "22"} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M11.9261 2.67646L17.3344 5.07813C18.8927 5.76563 18.8927 6.9023 17.3344 7.5898L11.9261 9.99146C11.3119 10.2665 10.3036 10.2665 9.68939 9.99146L4.28105 7.5898C2.72272 6.9023 2.72272 5.76563 4.28105 5.07813L9.68939 2.67646C10.3036 2.40146 11.3119 2.40146 11.9261 2.67646Z" stroke={stroke ?? "#8B8B93"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M2.75 10.0835C2.75 10.8535 3.3275 11.7427 4.03333 12.0543L10.2575 14.8227C10.7342 15.0335 11.275 15.0335 11.7425 14.8227L17.9667 12.0543C18.6725 11.7427 19.25 10.8535 19.25 10.0835" stroke={stroke ?? "#8B8B93"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
